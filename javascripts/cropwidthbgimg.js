  ...
  var cropbox = function(options, el){
      var el = el || $(options.imageBox),
          ...
          obj = {
            ...
            getDataURL: function () {
              var width = this.thumbBox.width(),
                  ...
                  imgTop = $(el).find('img').css('top'),
                  imgLeft = $(el).find('img').css('left'),

                  imgWidth = $(el).find('img').width(),
                  imgHeight = $(el).find('img').height(),

                  dx = parseInt(imgLeft) - el.width()/2 + width/2,
                  dy = parseInt(imgTop) - el.height()/2 + height/2,
                  dw = parseInt(imgWidth),
                  dh = parseInt(imgHeight),
          ...
          setBackground = function(ratio, strech) {
            ...
            console.log(bgposX, pw, newSizeW, sizeW);
            console.log(bgposY, ph, newSizeH, sizeH);
    ...
    obj.image.onload = function() {
      ...
      el.append($('<img src="' + obj.image.src + '">'));
